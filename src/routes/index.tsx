...
function LandingPage() {
  ...
  return <ComingSoon onEnter={() => setShowSite(true)} />;
}

function ComingSoon({ onEnter }: { onEnter: () => void }) {
  return (
    <div className="min-h-screen bg-espresso text-cream flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 max-w-2xl mx-auto flex flex-col items-center">
        <p className="text-champagne uppercase tracking-[0.4em] text-xs mb-6 font-medium">
          Coming Soon
        </p>
      ...
      {/* Secret entrance star icon */}
      <button
        onClick={onEnter}
        className="absolute bottom-6 left-6 text-cream/10 hover:text-champagne transition-all duration-300 hover:scale-110 z-50"
...
function RealSite() {
  return (
    <div className="min-h-screen bg-cream text-ink animate-in fade-in duration-700">
      <Header />
